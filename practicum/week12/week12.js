...
const makeOne = () => {
	...
	const num2 = 10;
	const sum = num1+num2;
	resultOne.textContent = `Сумма = ${sum}`;
};
...
const makeTwo = () => {
	...
	resultTwo.textContent = `Разность = ${difference}`;
};
...
const makeThree = () => {
	...
	resultThree.textContent = `Произведение = ${product}`;
};
...
const makeFour = () => {
	...
	resultFour.textContent = `Частное = ${quotient}`;
};
...
const makeFive = () => {
	const num = 3;
	const power = 4;
	const res = Math.pow(num, power);
	resultFive.textContent = `3 в 4 степени = ${res}`;
};
...
const makeSix = () => {
	...
	const num2 = 5;
	const quotient = num1/num2;
	resultSix.textContent = `Результат деления = ${quotient}`;
};
...
const makeSeven = () => {
	...
	resultSeven.textContent = `Остаток от деления = ${remainder}`;
};
...
const makeEight = () => {
	...
	resultEight.textContent = `Остаток от деления = ${remainder}`;
};
...
const makeNine = () => {
	...
	resultNine.textContent = `Остаток от деления = ${remainder}`;
};
...
const makeTen = () => {
	const str = 'Hello';
	resultTen.textContent = `Символ с индексом 2 = ${str[2]}`;
};
...
const makeTwentyOne = () => {
	resultTwentyOne.textContent = Math.floor(Math.random()*10);
};
...
const makeTwentySeven = (min, max) => {
	resultTwentySeven.textContent = Math.floor(Math.random()*(max - min) + min);
};

//Добавьте слушатель события
buttonTwentySeven.addEventListener('click', () => {
	makeTwentySeven(50, 100)});
